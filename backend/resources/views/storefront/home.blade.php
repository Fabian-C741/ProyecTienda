...
<section class="relative bg-gradient-to-r from-gray-900 to-gray-800 text-white">
    ...
    <div class="relative container mx-auto px-4 py-24">
        <div class="max-w-2xl">
            ...
            @else
            <a href="{{ route('storefront.products') }}" class="btn-primary text-white px-8 py-4 rounded-lg text-lg font-bold inline-block hover:shadow-lg transition">
                Ver Productos
            </a>
            @endif
        </div>
...
<section class="container mx-auto px-4 py-16">
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="{{ route('storefront.products') }}" class="text-primary hover:underline font-medium">
...
<section class="bg-gray-100 py-16">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            <a href="{{ route('storefront.products', ['category' => $category->slug]) }}" class="bg-white rounded-lg p-6 text-center hover:shadow-lg transition group">
                @if($category->icon)
